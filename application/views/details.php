...
<main class="site-main page-spacing">
    ...
    text-align: justify;"><?= $service->grand_desc ?></p>
                   ...
                   <?php
                    ...
                    <h3><b>HOTEL MAKKA: &nbsp;<a role="button" style="color:#6d071a;"title="<?= $service->titre_hotel ?>"><?= $service->titre_hotel ?></a>– Face Haram</b></h3> 
                    <p style="    font-family: sans-serif;
    font-size: medium;
    text-align: justify;"><?= $service->desc_hotel ?></p>
         <div   class="gallery container-fluid" style="padding:2em; ">
            ...
            <?php
                    ...
                    ?>
                     <h3><b>HOTEL MEDINA: &nbsp;<a role="button" style="color:#6d071a;"title="<?= $service->titre_hotel_Medina ?>"><?= $service->titre_hotel_Medina?></a>– Face Haram</b></h3> 
                    <p style="    font-family: sans-serif;
    font-size: medium;
    text-align: justify;"><?= $service->desc_hotel ?></p>
         <div   class="gallery container-fluid" style="padding:2em; ">
...
">
    ...
    text-align: center;color:#6d071a;text-decoration: underline;"><?= $chambre->prix ?></h4><?php } }?>
  </div>    
</div>
</div>
   ...
   <?php foreach ($chambres as $chambre){
    ...
    text-align: center;color:#6d071a;text-decoration: underline;"><?= $chambre->prix ?></h4><?php } }?>
            ...
            <!-- <?php
                    ...
                    <h3><b>HOTEL: &nbsp;<a role="button" style="color:#6d071a;"title="<?= $service->titre_hotel ?>"><?= $service->titre_hotel ?></a>– Face Haram</b></h3> 
                    <p style="    font-family: sans-serif;
    font-size: medium;
    text-align: justify;"><?= $service->desc_hotel ?></p>
         <div   class="gallery container-fluid" style="padding:2em; ">
            ...
            <div class="bookhotel-block " style="width:30%;padding:0px 2em;float:left;display:block;">
                <div class="row" >
                    <div class="col-12 bookhotelbox" >
                        ...
                        <div class="bookhotel-content" style="height: 192px;background:#6d071a;">
