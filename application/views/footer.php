            ...
            <div class="container">
                <div class="row">
                    ...
                    <aside class="col-md-2 col-sm-6 col-xs-6 ftr-widget link_widget">
                        ...
                        <a <?php if($page_name == "Deals Hotels"){ ?> class="active" <?php } ?> href="<?= base_url()?>hotels.html"  title="About Us">Hajj</a>
                        <a <?php if($page_name == "Deals Hotels"){ ?> class="active" <?php } ?> href="<?= base_url()?>voyages-organises.html"   title="ventes">Omra</a>
                    ...
                    <aside class="col-md-4 col-sm-6 col-xs-6 ftr-widget openinghours_widget">
                         <a href="<?= base_url()?>/"><img src="<?= base_url()?>assets/frontend/images/tariq makkah logo.png" alt="logo" height="52"  style="width:100%; margin-top:40px" />
                    </aside>
                    <!-- Widget Link /- -->
                    ...
                    <!--</aside>-->
                    <!-- Widget PopularDestination /- -->
                    <center><div class="col-md-12 ftr-newsletter">
                        <!-- <h3>inscription newsletter</h3> -->
                        <form id="newsletter" action="<?= base_url()?>addmail" method="post">
                            <div class="input-group">
                                <input type="text" placeholder="Enter Votre adresse email" name="email" id="email"class="form-control" required>
                                <span class="input-group-btn">
									<button type="submit" class="btn">Inscrivez-vous maintenant</button>
								</span>
                            </div>
                        </form>
                    </div></center>
